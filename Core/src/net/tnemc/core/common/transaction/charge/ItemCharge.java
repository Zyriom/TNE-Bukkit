...
/**
 * Represents a charge that is associated with items.
 *
 * @see Charge
 * @since 0.1.1.17
 * @author creatorfromhell
 */
public class ItemCharge implements Charge {

  private Account account;
  private BigDecimal amount;
  private SerialItem item;

  public ItemCharge(Account account, BigDecimal amount, SerialItem item) {
